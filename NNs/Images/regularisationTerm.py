...
def run(dataset_name, dataset, setting):
    print(dataset_name+" regularisation term")
    ...
    for train_indices, val_indices in kf.split(data):
        ...
        optimizer = optim.SGD(network.parameters(), lr=setting.learning_rate, momentum=setting.momentum, weight_decay=1e-4)
    ...
    return create_numeric_run_object("Regularisation Term", seed, start_time, end_time, setting,
