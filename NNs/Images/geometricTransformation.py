...
def run(dataset_name, settings, training_set, validation_set):
    print(dataset_name + " geometric transformation run")
    ...
    monitor = Monitor("Geometric transformation", dataset_name, seed, loss_function, settings.log_interval, x_validation, y_validation)
